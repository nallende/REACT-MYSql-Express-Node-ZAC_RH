...
const Usuario = () => {
    ...
    useEffect(() => {
        const getDatos = async () =>{
            const res = await fetch('http://localhost:8000/salud')
        ...
        <div className="container">
            <div className="row">
              <div className="col-6">
                {editing ?(
                  <div>
                    <h2 style={{textAlign:'center'}}>Editar Registro de salud</h2>
                    <UpdateData
                  ...
                  <div>
                    <h2 style={{textAlign:'center'}}>Registro de salud</h2>
                ...
                <div className="col-6">
                    <h2 style={{textAlign:'center'}}>Lista de salud</h2>
